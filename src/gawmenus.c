...
static void
aw_show_github_gaction (GSimpleAction *action, GVariant *param,  gpointer user_data )
{
   UserData *ud = (UserData *) user_data;
   ah_show_github_dialog (ud); 
}
...
"        <child>"
"          <object class='GtkScrolledWindow' id='siglist_scrolled'>"
...
"          <attribute name='action'>gaw.ExportImg</attribute>"
"          <attribute name='icon'>media-playlist-repeat-symbolic</attribute>"
"        </item>"
"      </section>"
"      <section>"
"        <item>"
...
"          <attribute name='icon'>zoom-fit-best-symbolic</attribute>"
"        </item>"
"        <item>"
...
"          <attribute name='icon'>zoom-out-symbolic</attribute>"
...
"          <attribute name='icon'>zoom-in-symbolic</attribute>"
...
"          <attribute name='icon'>emblem-default-symbolic</attribute>"
"        </item>"
"        <item>"
...
"          <attribute name='icon'>user-home-symbolic</attribute>"
"        </item>"
"        <item>"
"          <attribute name='label' translatable='yes'>Gawm GitHub</attribute>"
"          <attribute name='action'>gaw.GawmGitHub</attribute>"
"          <attribute name='icon'>user-home-symbolic</attribute>"
"        </item>"
"      </section>"
"    </submenu>"
...
static TooltipInfo menubarTip[] = {
   ...
   { "GawmGitHub", N_("Gawm GitHub"), N_("Gawm GitHub Repository"), NULL  },
   { "UserGuide", N_("User Guide"), N_("Gawm User Guide"), NULL  },
...
static GActionEntry entries[] = {
   ...
   { "GawmGitHub", aw_show_github_gaction, NULL, NULL, NULL  },
