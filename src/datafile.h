...
struct _DataFile {
   ...
   GtkTreeStore *wlist_store;  /* tree store for hierarchical signal list */
   GtkWidget *wlist_treeview;  /* tree view widget for signal list */
   GtkTreeIter wlist_root_iter; /* root iter for file node in tree */
