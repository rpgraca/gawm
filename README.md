...
**Gawm** is a modernized fork of [Gaw](http://www.rvq.fr/linux/gaw.php), a tool for viewing analog data, such as the output of Spice simulations. This fork aims to provide improved visualization.
